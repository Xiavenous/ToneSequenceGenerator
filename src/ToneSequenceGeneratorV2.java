...
public class ToneSequenceGeneratorV2 {
    ...
    public static void main(String[] args) throws IOException, UnsupportedAudioFileException, LineUnavailableException {
        ...
        if ("record".equals(response)){
            try {
                // Set up audio format
                AudioFormat format = new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, 2.0f, 16, 1, 2, 2.0f, false);
    ...
    private static byte[] generateAudio(AudioFormat format) {
        ...
        for (int i = sampleRate * 3; i < sampleRate * 8; i++) {
